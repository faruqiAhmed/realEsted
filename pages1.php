                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                            <div class="form-group">
                                <select class="from-control" name="location" data-live-search="true" data-live-search-placeholder="Search value">
                                 ...
                                 <?php
                            $sql = "SELECT DISTINCT  location_city FROM  proparty";
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                            <div class="form-group">
                                <select class="from-control" name="area" data-live-search="true" data-live-search-placeholder="Search value">
                                 ...
                                 <?php
                            $sql = "SELECT DISTINCT  location_address FROM  proparty";
                            $result = mysqli_query($con, $sql);
...
.pagination a:hover:not(.active) {background-color: #ddd;}
  ...
  <a href="#">&laquo;</a>
  <a href="buy.php">1</a>
  <a class="active" href="buy.php/page/2">2</a>
  <a href="buy.php/page/3">3</a>
   <a href="#">&raquo;</a>
