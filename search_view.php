		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			...
			<div class="heading-properties clearfix sidebar-widget">
				...
				<div class="pull-right">
					<h3><span>TAKA <?php echo $product_info['product_price']; ?></span></h3>
					<h5>
						<?php echo $product_info['stock_amount']; ?> sq.ft/kata
					</h5>
				</div>
			</div>
					...
					<div id="carousel-custom" class="carousel slide" data-ride="carousel">
						<div class="carousel-outer">
							<!-- Wrapper for slides -->
								...
								<div class="item">
									<img src="asset/<?php echo $product_info['product_image']; ?>" class="thumb-preview" alt="Chevrolet Impala" width="500" height="500">
								</div>
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab1default">
									<div class="main-title-2">
										<a href="<?php  echo $product_info['product_short_description']; ?>">Video</a></li>
									</div>
								...
								<div class="tab-pane fade" id="tab2default">
                                   ...
                                   <h1><span>Description</span></h1>								
									...
									<p> <?php  echo $product_info['minimum_stock_amount']; ?></p>
								</div>
								...
								<div class="tab-pane fade" id="tab3default">
                                   ...
                                   <h1><span>google map</span></h1>								
									...
									<a href="<?php  echo $product_info['product_long_description']; ?>">google map</a></li>
								</div>
