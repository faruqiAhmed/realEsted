        ...
        <nav class="navbar navbar-default">
            ...
            <div class="navbar-collapse collapse" role="navigation" aria-expanded="true" id="app-navigation">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="index.php">My Property</a></li>
                    
                    <li><a href="contact-2.php"></a></li>
                </ul>
                    ...
                    <form method="post" enctype="multipart/form-data" action="information.php">
                        ...
                        <div class="search-contents-sidebar">
                            <div class="form-group">
                                ...
                                <input type="text" class="input-text" name="ptitle" placeholder="Property Title">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input type="text" class="input-text" name="pri" placeholder="USD">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
...
<!--                         <div id="myDropZone" class="dropzone dropzone-design">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>State</label>
                                    <select class="selectpicker search-fields" name="choos" data-live-search="true" data-live-search-placeholder="Search value">
