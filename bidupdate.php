	...
	try 
		{
			...
			$stmt = $conn->query("update admin set `adminUserName`='$adminUserName', `adminFullName`='$adminFullName', `adminEmail`='$adminEmail', `adminPassword`='$adminPassword', 
			`adminContact`='$adminMobile', `adminAddress`='$adminAddress', `adminBranch`='$adminBranch' where id='$id'");
...
<html>
    ...
    <body style="background-color: #f1f1f1">
        ...
        <?php
            ...
            $adminMobile = $_POST["adminContact"];
