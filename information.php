...
<?php
  ...
  if (isset($_POST["save"]) && $_POST['save'] != null) {
    ...
    if ($_POST['apartment'] == 'Apartment') {
		...
		$sql = "INSERT INTO proparty(  status, property_type, price, area, room, bathroom, kitchen, photo_gallery, location_address, location_city,youtube_link,google_map,details_information, contact_name, contact_email, contact_number,publicationdate) VALUES ('$b','$c','$d','$e','$f','$g','$kitchen','$uploaded_image', '$i','$j','$youtube','$google','$m','$n','$o','$p','$fromDate')";
