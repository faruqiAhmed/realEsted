...
$get = new GetUser();
    ...
    if(isset($_GET['detailsid'])){
        $proId = $_GET['detailsid'];
    }
    if($get->checkBooking($proId)){
        $proLinkId = "disabled";
    }
...
<div class="container">
	...
	<div class="row">
		...
		<?php
				$id = $_GET['detailsid'];
				$sql = "SELECT * FROM  reant where properrty_id = {$id}";
			...
			<div class="Properties-details-section sidebar-widget">
				...
				<div class="panel-box properties-panel-box Property-description">
					<ul class="nav nav-tabs">
						...
						<!---<li class=""><a href="#tab4default" data-toggle="tab" aria-expanded="false">Bid</a></li>--->
					</ul>
	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			...
			<div class="sidebar right">
				...
				<div class="sidebar-widget contact-form agent-widget">
					<div class="main-title-2">
						<h1><span>Booking</span> product</h1>
					</div>
						<div class="row">
							
							<div class="col-lg-12">
								<a id="<?php echo $proLinkId; ?>"  href="#" class="button-md button-theme btn-block <?php echo $class; ?>">Booking Now</a>
							</div>
						</div>
					</form>
				</div>
...
<div id="sm-model" class="sm-model">
    ...
    <div class="sm-model-content">
        ...
        <div id="sm-model-terms" class="sm-model-terms">
            <div class="sm-title">Are you agree?</div>
            <!--<p id="sm-active-info">If you did'nt receive. <a href="#">Resend Code</a></p>-->
           <form action="#" id="sm-terms-submit">
                  <input name="booking" type="hidden" value="<?php echo $_GET['detailsid']; ?>">
                  <input name="email" type="hidden" value="<?php echo Session::get('email'); ?>">
                  <div class="row">
               <input type="checkbox" name="check" required> <a href="#">In seven days  &amp; the payment will be paid</a>
               <div class="row">
               <input type="checkbox" name="check" required> <a href="#"> you will be given your Nid copy of the scan at the email</a>
