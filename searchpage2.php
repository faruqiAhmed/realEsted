...
<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        // var_dump($area);
        // exit();
		$sql = "SELECT * FROM reant where  status LIKE '%$status%' and property_type LIKE '%$property%'  or location_city LIKE '%$location%' and location_address LIKE '%$area%'";
